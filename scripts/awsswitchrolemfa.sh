...
usage()
{
  ...
  echo "arg1 = Role ARN (from .aws/config) (Example: arn:aws:iam::171325405593:role/production-admin-cross-account-role)"
  echo "arg2 = Role Session Name (Example: AWSCLI-Session)"
  echo "arg3 = Token Code (from Keepass --> <Key Name> --> KeeOtp2 --> Copy TOTP) (Example: 123456)"
